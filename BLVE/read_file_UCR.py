...
class Data_Hanlder(object):
    ...
    def _split_save_data(self):
        ...
        x_train, x_test, y_train, y_test = train_test_split(self.all_data, self.all_labels, test_size=0.45, #0.15
                                                            random_state=42)
        ...
        print('test label',Counter(self.test_label))
        ...
        # np.save('arrange/train_anomally.npy', y_train)
