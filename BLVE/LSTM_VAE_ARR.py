    ...
    def _build_network(self):
        ...
        with tf.variable_scope('encoder'):
            ...
            with tf.variable_scope('lat_sigma'):
                ...
                self.sample_Z = mu_outputs + sigma_outputs * tf.random_normal(
                    tf.shape(mu_outputs),
...
def main():
    ...
    config['time_steps'] = 1
    config['z_dim'] = 64  # 潜在空间维度 default=64
    ...
    config['train_iters'] = 20000  # 1个iteration等于使用batchsize个样本训练一次 default=20000
    ...
    with open('result/resultARRHYTHMIA.txt', 'a') as result:
