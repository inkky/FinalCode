...
import importlib
import sys
import bigan.arrhythmia_utilities as network
import data.arrhythmia as data
...
def train_and_test(nb_epochs, weight, method, degree, random_seed):
    ...
    """
    logger = logging.getLogger("BiGAN.train.arrhythmia.{}".format(method))
    ...
    with sv.managed_session() as sess:
        ...
        fill = np.ones([batch_size - size, 274])
